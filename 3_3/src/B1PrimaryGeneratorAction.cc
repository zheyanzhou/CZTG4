...
//G4UniformRand():pruduce a random number from 0 to 1
  G4double size = 0.8; 
  ...
  */
  ...
  G4double x0 = 9*G4UniformRand()*mm;
  G4double y0 = 9*G4UniformRand()*mm;
  G4double z0 = 0*mm;
  ...
  /////////////////////////////////////
   ...
   std::ofstream out;
     out.open("gun_position.txt",std::ios::app);
     out<<x0<<" "<<y0<<std::endl;
     out.close();
  ...
  G4double a=2*G4UniformRand()-1;
  G4double b=2*G4UniformRand()-1;
